...
application.add_handler(CommandHandler('createMatch', commands.createMatch))
application.add_handler(CommandHandler('accept', commands.accept))
application.add_handler(CommandHandler('decline', commands.decline))